...
const notifications = [
  {
    icon: <LuMail className="text-gray-500 mr-2" />,
  ...
  {
    icon: <LuMail className="text-blue-500 mr-2" />,
  ...
  {
    icon: <LuMail className="text-red-500 mr-2" />,
    ...
    financials: [
      ...
      {
        label: "Energy Generation and Storage Segment Revenue",
        value: "2.38B",
        growth: 52,
        unit: "% YoY",
      },
...
const transactionRelatedFilings = [
  {
    ...
    summary:
      "Record Q4 revenue of $94.9B amid product launches and AI features debut",
    positiveDevelopments:
      "6% revenue growth, Services revenue at all-time high, new product launches",
    potentialConcerns:
      "$10.2B one-time tax charge, slight decline in Greater China revenue",
    structuralChanges: "Introduction of Apple Intelligence AI features",
    additionalNotes:
      "Q4 earnings call scheduled for October 31, 2024 at 2:00 p.m. PT",
  },
  {
    company: "Microsoft Corporation (MSFT)",
    ...
    summary:
      "Annual shareholder meeting concludes with board re-elections; $800M Cruise investment impairment announced",
    positiveDevelopments:
      "All directors re-elected with 90%+ approval; Deloitte & Touche appointment approved",
    potentialConcerns:
      "$800M impairment charge on Cruise investment; growing shareholder interest in AI governance",
    structuralChanges: "None reported",
    additionalNotes:
      "Multiple AI-related shareholder proposals rejected; Q2 EPS impact of $0.09 expected",
  },
  {
    company: "Tesla, Inc. (TSLA)",
    ...
    eventType: "Quarterly Results",
    summary:
      "Tesla hits Q4 records: 495K vehicles delivered, 11GWh energy deployed",
    positiveDevelopments:
      "Record Q4 deliveries (495K), annual production (1.77M), energy storage growth (11GWh)",
    potentialConcerns:
      "5-6% vehicles under lease, delivery exceeds production by 36K units",
    structuralChanges: "None reported",
  ...
  },
  {
    ...
    summary:
      "Hershey CEO Michele Buck elected to JPMorgan board, effective March 2025",
    positiveDevelopments:
      "Strategic addition of Fortune 500 CEO with 30+ years consumer experience",
    potentialConcerns: "None reported",
    structuralChanges:
      "Addition of new board member with consumer transformation expertise",
    additionalNotes:
      "Buck also serves on New York Life board, has extensive operational experience",
  },
  {
    ...
    eventType: "Quarterly Results",
    summary:
      "Q1 FY25 shows 7.5% revenue growth with strong e-commerce and membership gains",
    positiveDevelopments:
      "Net sales up 7.5%, e-commerce sales up 13%, membership growth 7.6%",
    ...
    additionalNotes:
      "90.4% worldwide membership renewal rate, expanding Kirkland Signature product line",
  },
];
...
const ownershipChanges = [
  {
    ...
    summary:
      "Apple Inc. COO Jeffrey Williams sold 100,000 shares of Common Stock through four transactions on Dec 16, 2024, with prices ranging from $248.61 to $251.10 per share, totaling $24,997,418.27. The sales were executed under a Rule 10b5-1 trading plan, with shares held through his living trust. This reduced his holdings by 20.41% from 489,944 to 389,944 shares.",
  },
  {
    ...
    summary:
      "Disposition of 617.402 shares of Common Stock at $447.27 per share through tax withholding (Transaction Code F).",
  },
  {
    company: "Tesla, Inc. (TSLA)",
    ...
    summary:
      "Gifted 268,000 shares of Common Stock to charitable organizations as part of year-end tax planning.",
  },
  {
    company: "JPMorgan Chase & Co (JPM)",
    ...
    summary:
      "Acquisition of 234.6585 shares of Common Stock as part of quarterly director retainer deferral program at $239.71 per share.",
  },
  {
    ...
    summary:
      "Gift disposition of 2,017 shares of Common Stock, comprising 17 shares to a charitable non-profit organization and 2,000 shares to a donor advised fund.",
  },
];
